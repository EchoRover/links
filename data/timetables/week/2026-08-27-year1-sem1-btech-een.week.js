// 2026-08-27-year1-sem1-btech-een.pdf
...
const WEEK = {
    1: [ // Monday
        ...
        ["09:00", "11:00", "AELL1000", "M3-1-014", "lab", 0],
    ...
    2: [ // Tuesday
        ...
        ["11:00", "12:00", "ACML1001", "M2-2-009", "tut", 3],
        ["11:00", "12:00", "AMTL1001", "M2-2-015", "tut", 4],
    ...
    4: [ // Thursday
        ...
        ["11:00", "12:00", "ACML1001", "M2-2-009", "tut", 4],
        ["12:00", "15:00", "AELL1000", "M4-0-005", "", 0],
        ["15:00", "16:00", "ACML1001", "M2-2-009", "tut", 1],
        ["15:00", "19:00", "ACMP1000", "M3-1-029", "lab", 0],
        ["15:00", "17:00", "ACOL1000", "M3-1-004", "lab", 0],
        ["16:00", "18:00", "AELL1000", "M3-1-014", "lab", 0],
        ["17:00", "19:00", "ACOL1000", "M3-1-004", "lab", 0],
    ],
    5: [ // Friday
        ["08:00", "12:00", "ACMP1000", "M3-1-029", "lab", 0],
...
// 35 cell(s) with no course code (reserved slots, lunch, free text) — not classes:
...
//   Thursday 09:00  May be used for additional classes
//   ... and 23 more
